...
pipeline {
    ...
    stages {
        stage('Create and push images') {
            parallel {
                stage('Image for single instance deployment with python 3.9 published on Harbor') {
                    steps {
                        script {
                ...
                stage('Image for single instance deployment with python 3.9 published on DockerHub') {
                    steps {
                        script {
                            dockerRepository.buildAndPushImage(
